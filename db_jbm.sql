...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2023 at 05:55 PM
...
(6, 'BRG0006', 'Freon AC', 320000, 20, NULL, NULL, NULL, NULL),
(7, 'BRG0007', 'Aki GS ASTRA', 80000, 25, NULL, NULL, NULL, NULL);
...
(11, 0, 3, 18, '2023-05-05', 0, 0, 600000, 1000000, 400000),
...
--
ALTER TABLE `tbl_service`
  MODIFY `servis_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
