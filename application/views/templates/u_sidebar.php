<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="<?= site_url('landing') ?>" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <i class="fas fa-car fa-2x text-secondary"></i>
                    </span>
                    <span class="mt-1 ms-1 sidebar-text">JBM User Panel</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="<?= site_url('user/riwayat/' . $tbl_user['id']) ?>" class="nav-link">
                    ...
                    <span class="sidebar-text">Riwayat Servis</span>
                </a>
            </li>
            <!-- <li class="nav-item">
