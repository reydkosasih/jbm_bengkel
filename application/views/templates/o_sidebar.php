        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="<?= base_url('tempset/') ?>index.html" class="nav-link d-flex align-items-center">
                    ...
                    <span class="mt-1 ms-1 sidebar-text">JBM Owner Panel</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= site_url('laporan/transaksi_owner') ?>" class="nav-link">
                    <span class="sidebar-icon">
            ...
            <li class="nav-item">
                <a href="<?= site_url('laporan/service_owner') ?>" class="nav-link">
                    <span class="sidebar-icon">
                        <i class="fas fa-book icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20">
                        </i>
                    </span>
                    <span class="sidebar-text">Laporan Service</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= site_url('laporan/sparepart_owner') ?>" class="nav-link">
                    <span class="sidebar-icon">
                        <i class="fas fa-book icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20">
                        </i>
                    </span>
                    <span class="sidebar-text">Laporan Sparepart</span>
                </a>
            </li>
